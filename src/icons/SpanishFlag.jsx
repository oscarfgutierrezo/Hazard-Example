export const SpanishFlag = () => {
  return (
    <svg version="1.1" x="0px" y="0px" width="100%" height="100%" viewBox="0 0 130 120" enableBackground="new 0 0 130 120" xmlSpace="preserve">
      <g id="Infos">
        <rect id="BG" x="-1250" y="-1020" fill="#D8D8D8"/>
      </g>
      <g id="Others">
      </g>
      <g id="Europe">
